...
exports.insertcourt = async function(req, res, next) {
    ...
    if (court_name != "" && incharge_name != "" && court_email != "" && court_phone != "" && court_postal_code != "" && court_address != "") {
        ...
        var query = "INSERT INTO `tenniscourt`(`court_name`, `incharge_name`, `court_email`, `court_phone`, `court_postal_code`, `court_address`,`created_time`)" +
            " VALUES ('" + court_name + "','" + incharge_name + "','" + court_email + "','" + court_phone + "','" + court_postal_code + "','" + court_address + "','" + newdate + "')";
...
exports.updatecourt = async function(req, res, next) {
    ...
    if (court_name != "" && incharge_name != "" && court_email != "" && court_phone != "" && court_postal_code != "" && court_address != "") {
        ...
        var query = "UPDATE `tenniscourt` SET `court_name` = '" + court_name + "', `incharge_name`='" + incharge_name + "', `court_email`='" + court_email + "', `court_phone`='" + court_phone + "'," +
            " `court_postal_code`='" + court_postal_code + "', `court_address`='" + court_address + "',`updated_time`='" + updateddate + "' WHERE `court_id`='" + court_id + "';";
...
exports.getallcourts = async function(req, res, next) {
    var _output = new output();
    await db_library
        .execute("SELECT * FROM `tenniscourt`").then((value) => {
