...
router.post('/admin/coachstatustoinactive', coachController.coachstatustoinactive);
...
router.post('/admin/courtstatustoinactive', courtController.courtstatustoinactive);
